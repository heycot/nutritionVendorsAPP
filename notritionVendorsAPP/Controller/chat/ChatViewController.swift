...
//        messageInputBar.setStackViewItems([cameraItem as! InputItem], forStack: .left, animated: false) // 3
//    }
//    
...
////        }
////
////        let channel_id = user.id! + shop.user_id!
////
//////        let channel = Channel(id: channel_id, name: channelName)
////        let channel = Channel(id: channel_id, name: channel_title)
